...
namespace Core.Mappy.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IMapper RegisterMappings(this IMapper mapper, Assembly assembly)
        {
